...
public class Biblioteca {
    ...
    /**
     * Asigna a la biblioteca un listado de libros que se pasa por parÃ¡metro.
     ...
     * @param nuevo Objeto de tipo Libro que se añade
    ...
    */
    ...
    /**
     * Obtiene el numero de libros de la biblioteca.
    ...
    public String toString() {
        ...
        if (libros.isEmpty()) {
            listado = "La biblioteca esta vaci­a";
        } else {
            for (Libro l : libros) {
